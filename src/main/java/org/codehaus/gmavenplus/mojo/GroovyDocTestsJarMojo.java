...
/**
 * Create a GroovyDoc jar for the test sources. Note by default this will also invoke the <i>groovydocTests</i> goal
 * (unless invokeGroovyDoc is <code>false</code>).
 *
 * @author Keegan Witt
 * @since 1.7.1
 */
...
public class GroovyDocTestsJarMojo extends GroovyDocTestsMojo {
    ...
    /**
     * Specifies the filename that will be used for the generated jar file. Please note that <code>-test-groovydoc</code>
